...
```
$ go get -u -d github.com/graux/migrate/cli github.com/lib/pq
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/graux/migrate/cli
```
...
```
$ curl -L https://packagecloud.io/graux/migrate/gpgkey | apt-key add -
$ echo "deb https://packagecloud.io/graux/migrate/ubuntu/ xenial main" > /etc/apt/sources.list.d/migrate.list
$ apt-get update
...
[Release Downloads](https://github.com/graux/migrate/releases)

```
$ curl -L https://github.com/graux/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
